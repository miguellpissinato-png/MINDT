...
var TEXTOS = {
  ...
  deQuatroConcluidos:{pt:'de 4 concluídos',en:'of 4 done'},
  treinosSemana:{pt:'Treinos na semana',en:'Workouts this week'},
  tag_exercicio:{pt:'EXERCÍCIO',en:'EXERCISE'},
  day_exercicio:{pt:'Exercício do dia concluído',en:"Today's exercise done"},
  ...
  semPendencias:{pt:'Nada em aberto. Dia limpo.',en:'Nothing open. Clear day.'},
...
"Semana":"Week","Mês":"Month","Ano":"Year","+ Nova modalidade":"+ New activity","Nova modalidade":"New activity",
"Rotina da semana":"Weekly routine","Editar rotina":"Edit routine","Recorde de percurso":"Distance record",
"No mês":"This month","Registrar corrida":"Log a run","Últimas corridas":"Recent runs",
"Meta diária":"Daily goal","Registrar passos":"Log steps","Circuito":"Circuit",
"Adicionar exercício":"Add exercise","Novo exercício":"New exercise","Séries":"Sets","Repetições":"Reps",
"Distância (km)":"Distance (km)","Tempo":"Time","Passos":"Steps","Dia":"Day",
"Rotina de academia":"Gym routine","Salvar rotina":"Save routine","Adicionar":"Add","Registrar":"Log",
"▶ Iniciar treino":"▶ Start workout","✓ Finalizar treino":"✓ Finish workout",
"Esta modalidade usa só o cronômetro.":"This activity uses the timer only.",
"O formulário de rotina se adapta ao tipo que você escolher.":"The routine form adapts to the type you pick.",
"Selecione o grupo muscular deste dia da semana. Até dois por dia.":"Pick the muscle group for each weekday. Up to two per day.",
"Quanto você percorreu hoje?":"How far did you go today?",
"O navegador não lê o pedômetro do celular, então os passos entram à mão.":"The browser cannot read your phone pedometer, so steps are entered by hand.",
"Pendências":"Pending","Total gasto":"Total spent","Maior categoria":"Biggest category","Média por lançamento":"Average per entry","Tema":"Theme","Claro":"Light","Escuro":"Dark",
...
"Home":"Home","Metas":"Goals","Tarefas":"Tasks","Gastos":"Expenses","Agenda":"Agenda","Resumo":"Summary",
...
// Área de dinheiro: as três telas
"Dinheiro":"Money","Ganhos":"Income","Geral":"Overview",
"🏦 Nova instituição":"🏦 New institution","+ Registrar entrada":"+ Add income",
"Nova instituição":"New institution","Renomear instituição":"Rename institution",
"Nome da instituição":"Institution name","Registrar entrada":"Add income","Editar entrada":"Edit income",
"Quantia (R$)":"Amount ($)","Instituição":"Institution","De onde veio":"Where it came from",
"Entrada recorrente":"Recurring income","Cai todo mês":"Every month","Dia do mês":"Day of the month",
"Forma de pagamento":"Payment method",
"Total que você tem":"What you have","Últimos gastos":"Latest expenses",
"Últimos lançamentos":"Latest income","Últimos investimentos":"Latest investments",
"Em breve":"Coming soon","Em breve.":"Coming soon.",
"Como o seu dinheiro se divide":"How your money splits",
"Gastos por categoria":"Expenses by category","Entradas por origem":"Income by source",
"Investimentos":"Investments","Médias por classificação":"Averages by classification",
"Entradas":"Income","Em que dia da semana você mais gasta":"Which weekday you spend the most",
"Coluna":"Column","Linha":"Line","Histórico por origem":"History by source",
"De onde vem o seu dinheiro":"Where your money comes from",
"Frequência de cada origem":"How often each source shows up",
"Excluir instituição":"Delete institution","Média por lançamento":"Average per entry"
};
